...
class FlipBatchIterator(BatchIterator):
    """
    derive from the default BatchIterator class and override the transform() method only
    # The flip_indices is derived from following features:
    ...
    def transform(self, Xb, yb):
        ...
        if yb is not None:
            # 1. Horizontal flip of all x coordinates:
            yb[indices, ::2] = yb[indices, ::2] * -1

            # 2. Swap places, e.g. left_eye_center_x -> right_eye_center_x
